...
class Student:
    def __init__(self, root):
        ...
        img = Image.open(
            r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\standford.jpg")
        img = img.resize((480, 100), Image.Resampling.LANCZOS)
        self.photoimg = ImageTk.PhotoImage(img)

        f_lbl = Label(self.root, image=self.photoimg)
        f_lbl.place(x=0, y=0, width=480, height=100)

        img1 = Image.open(
            r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\faces.png")
        img1 = img1.resize((480, 100), Image.Resampling.LANCZOS)
        self.photoimg1 = ImageTk.PhotoImage(img1)

        f_lbl = Label(self.root, image=self.photoimg1)
        f_lbl.place(x=480, y=0, width=480, height=100)
        ...
        img3 = Image.open(
            r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\bg.jpg")
        ...
        title_lbl = Label(bg_img, text="STUDENT MANAGEMENT", font=(
        ...
        img_left = Image.open(
            r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\att.jpg")
        img_left = img_left.resize((690, 100), Image.Resampling.LANCZOS)
        self.photoimg_left = ImageTk.PhotoImage(img_left)

        f_lbl = Label(Left_frame, image=self.photoimg_left)
        f_lbl.place(x=5, y=-2, width=690, height=100)
        ...
        current_course_frame.place(x=5, y=95, width=690, height=110)
        ...
        class_student_frame.place(x=5, y=205, width=690, height=320)
        ...
        Roll_no_entry = ttk.Entry(class_student_frame, textvariable=self.var_roll, font=(
            "times new roman", 13, "bold"), width=20)
        ...
        # Phone No
        PhoneNo_label = Label(class_student_frame, text="Phone", font=(
            "times new roman", 13, "bold"), bg="white")
        PhoneNo_label.grid(row=3, column=2, padx=10, pady=5, sticky=W)
        PhoneNo_entry = ttk.Entry(class_student_frame, textvariable=self.var_phone, font=(
            "times new roman", 13, "bold"), width=20)
        ...
        # Teacher Name
        TeacherName_label = Label(class_student_frame, text="Teacher", font=(
            "times new roman", 13, "bold"), bg="white")
        TeacherName_label.grid(row=4, column=2, padx=10, pady=5, sticky=W)
        TeacherName_entry = ttk.Entry(class_student_frame, textvariable=self.var_teacher, font=(
            "times new roman", 13, "bold"), width=20)
        ...
        radiobtn2.grid(row=6, column=1, padx=50)

        # buttonsframe
        btn_frame = Frame(class_student_frame, bd=2, relief=RIDGE, bg="white")
        btn_frame.place(x=0, y=195, width=685, height=35)
        ...
        btn_frame1.place(x=0, y=230, width=685, height=40)

        Take_btn = Button(btn_frame1, command=self.generate_dataset, text="Take Photo Sample", width=35, font=(
            "times new roman", 13, "bold"), bg="blue", fg="white")
        Take_btn.grid(row=0, column=0)

        Update_btn = Button(btn_frame1, text="Update Photo Sample",width=35, font=(
            "times new roman", 13, "bold"), bg="blue", fg="white")
        Update_btn.grid(row=0, column=1)
        ...
        img_right = Image.open(
            r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\OIP.jpg")
        img_right = img_right.resize((690, 130), Image.Resampling.LANCZOS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lbl = Label(Right_frame, image=self.photoimg_right)
        f_lbl.place(x=5, y=-2, width=680, height=130)
        ...
        search_combo = ttk.Combobox(Search_frame, font=(
            "times new roman", 12, "bold"), state="readonly", width=12)
        search_combo["values"] = ("Select ", "Roll_No", "Phone_No")
        search_combo.current(0)
        search_combo.grid(row=0, column=1, padx=2, pady=10, sticky=W)

        Search_entry = ttk.Entry(Search_frame, font=(
            "times new roman", 12, "bold"), width=12)
        ...
        table_frame.place(x=5, y=210, width=590, height=312)

        scroll_x = ttk.Scrollbar(table_frame, orient=HORIZONTAL)
        scroll_y = ttk.Scrollbar(table_frame, orient=VERTICAL)

        self.student_table = ttk.Treeview(table_frame, column=("dept", "course", "year", "sem", "id", "name", "div",
                                                               "roll", "gender", "dob", "email", "phone", "address", "teacher", "photo"), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dept.get() == "Select Department" or self.var_id.get() == "" or self.var_name.get() == "":
