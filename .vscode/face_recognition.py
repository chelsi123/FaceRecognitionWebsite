...
class Face_Recognition:
    def __init__(self, root):
        ...
        img_top = Image.open(r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\la.jpg")
        ...
        img_bottom = Image.open(r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\u.jpg")
        img_bottom = img_bottom.resize((800, 650), Image.Resampling.LANCZOS)
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)

        f_lbl = Label(self.root, image=self.photoimg_bottom)
        f_lbl.place(x=600, y=45, width=800, height=650)
        ...
        b1_1.place(x=365,y=550,width=200,height=40)
    
    def mark_attendance(self,i,r,n,d):
        with open(r"C:\Users\dell\OneDrive - Indian Institute of Technology (BHU), Varanasi\Desktop\face recognition system\.vscode\kiran.csv","r+",newline="\n") as f:
        ...
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence>75:
                    ...
                    cv2.putText(img,f"Depat:{d}",(x,y-5),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,0),3)
